...
class Decoder(tf.keras.layers.Layer):
    def __init__(self, num_layers,d_model,num_heads,dff, target_vocab_size, BertModel, maximum_position_encoding,   rate=0.1):
    ...
    def call(self, x, enc_output, training,look_ahead_mask=None, padding_mask=None):
        ...
        #x = self.embedding(x) # for random embeddings set d_model to 512.
        x = self.BertModel(x).last_hidden_state
...
class Transformer(tf.keras.Model):
    def __init__(self, num_layers, d_model, num_heads, dff,row_size,col_size,
              target_vocab_size, BertModel, max_pos_encoding, rate=0.1):
        super(Transformer, self).__init__()
        self.encoder = Encoder(num_layers, d_model, num_heads, dff,row_size,col_size, rate)
        self.decoder = Decoder(num_layers, d_model, num_heads, dff,
                          target_vocab_size, BertModel, max_pos_encoding, rate)
